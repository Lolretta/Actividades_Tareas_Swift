...
let card_data: [String: TipoInfo] = [
    ...
    "Electrico": TipoInfo(color: Color(hue: 0.14, saturation: 1.0, brightness: 1.0), emoji: "⚡️"),
    ...
    "Psiquico": TipoInfo(color: Color(hue: 0.9, saturation: 0.8, brightness: 1.0), emoji: "💫"),
